      ...
      <Grid container spacing={3} marginTop={1}>
          ...
          <Card>
            ...
            <CardContent sx={{ py: 2, px: 4 }}>
              ...
              <Typography variant="body1" paddingBottom={1}>
                ...
                the use of Jugadu's Website, located at https://jugadu.co.in.
              </Typography>
              <Typography variant="body1" paddingBottom={1}>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Jugadu if you do not agree to
        ...
        <Grid item xs={12}>
          <Card>
            ...
            <CardContent sx={{ py: 2, px: 4 }}>
              <Typography variant="body1" paddingBottom={1}>
                We employ the use of cookies. By accessing Jugadu, you agreed to
                use cookies in agreement with the Jugadu's Privacy Policy.
              </Typography>
              <Typography variant="body1" paddingBottom={1}>
          ...
          <Card>
            ...
            <CardContent sx={{ py: 2, px: 4 }}>
              <Typography variant="body1" paddingBottom={1}>
                ...
                from Jugadu for your own personal use subjected to restrictions
              ...
              <Typography variant="body1" paddingBottom={1}>
                ...
                reflect the views and opinions of Jugadu,its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, Jugadu shall not be liable for the
              ...
              <Typography variant="body1" paddingBottom={1}>
                Jugadu reserves the right to monitor all Comments and to remove
          ...
          <Card>
            ...
            <CardContent sx={{ py: 2, px: 4 }}>
                ...
                <Grid container xs={12} spacing={0}>
                  <ul>
                    <li>
                      <Grid item xs={12}>
                        <Text color="black">
                          Government agencies; Search engines; News
                          organizations; Online directory distributors may link
                          to our Website in the same manner as they hyperlink to
                          the Websites of other listed businesses; and System
                          wide Accredited Businesses except soliciting
                          non-profit organizations, charity shopping malls, and
                          charity fundraising groups which may not hyperlink to
                          our Web site. These organizations may link to our home
                          page, to publications or to other Website information
                          so long as the link: (a) is not in any way deceptive;
              ...
              <Typography variant="subtitle2">
                <Grid container xs={12} spacing={0}>
                  <ul>
                    ...
                    <li>
                      <Grid item xs={12}>
                        <Text color="black">dot.com community sites;</Text>
                      </Grid>
                    </li>
                    <li>
                      <Grid item xs={12}>
                    ...
                    <li>
                      <Grid item xs={12}>
                        <Text color="black">internet portals;</Text>
                      </Grid>
                    </li>
                    <li>
                      <Grid item xs={12}>
              ...
              <Typography variant="body1" paddingBottom={1}>
                ...
                of Jugadu; and (d) the link is in the context of general
              ...
              <Typography variant="body1" paddingBottom={1}>
                ...
                by sending an e-mail to Jugadu. Please include your name, your
        ...
        <Grid item xs={12}>
          <Card>
            ...
            >
              <Box>
                <Typography variant="h3">iFrames</Typography>
              </Box>
            </Box>
            <Divider />
            <CardContent sx={{ py: 2, px: 4 }}>
